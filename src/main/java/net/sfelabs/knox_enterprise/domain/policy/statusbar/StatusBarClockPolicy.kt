...
@PolicyDefinition(
    title = "Hide Status Bar Clock",
    description = "When enabled, hides the clock in the status bar.",
    category = PolicyCategory.Toggle,
    capabilities = [
        PolicyCapability.MODIFIES_DISPLAY,
    ]
)
class StatusBarClockPolicy : BooleanStatePolicy(StateMapping.INVERTED) {
