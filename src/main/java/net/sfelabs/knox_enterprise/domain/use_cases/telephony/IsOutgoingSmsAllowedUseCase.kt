...
class IsOutgoingSmsAllowedUseCase : WithAndroidApplicationContext, SuspendingUseCase<Unit, Boolean>() {
    ...
    override suspend fun execute(params: Unit): ApiResult<Boolean> {
        return ApiResult.Success(data = phoneRestrictionPolicy.isOutgoingSmsAllowed())
    }
}
