...
/**
 * Enable or disable automatic date/time synchronization.
 */
class SetAutomaticTimeStateUseCase : WithAndroidApplicationContext, SuspendingUseCase<Boolean, Unit>() {
    ...
    override suspend fun execute(params: Boolean): ApiResult<Unit> {
        dateTimePolicy.setAutomaticTime(params)
