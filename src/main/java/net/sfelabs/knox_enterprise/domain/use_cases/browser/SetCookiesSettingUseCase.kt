...
/**
 * Set browser cookies setting (enable or disable cookies).
 */
class SetCookiesSettingUseCase : WithAndroidApplicationContext, SuspendingUseCase<Boolean, Boolean>() {
    ...
    override suspend fun execute(params: Boolean): ApiResult<Boolean> {
        return ApiResult.Success(data = browserPolicy.setCookiesSetting(params))
    }
}
