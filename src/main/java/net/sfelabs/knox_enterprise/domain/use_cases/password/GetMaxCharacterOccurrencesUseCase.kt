...
class GetMaxCharacterOccurrencesUseCase : WithAndroidApplicationContext, SuspendingUseCase<Unit, Int>() {
    ...
    override suspend fun execute(params: Unit): ApiResult<Int> {
        // Note: Knox SDK uses misspelled "Occurences" (one 'r')
        return ApiResult.Success(data = passwordPolicy.maximumCharacterOccurences)
    }
}
