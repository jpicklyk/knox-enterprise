...
/**
 * Prevent or allow new admin installation.
 * @param params true to prevent, false to allow
 */
class PreventNewAdminInstallationUseCase : WithAndroidApplicationContext, SuspendingUseCase<Boolean, Boolean>() {
    ...
    override suspend fun execute(params: Boolean): ApiResult<Boolean> {
        return ApiResult.Success(data = applicationPolicy.preventNewAdminInstallation(params))
    }
}
