...
class GetMaxNumericSequenceLengthUseCase : WithAndroidApplicationContext, SuspendingUseCase<Unit, Int>() {
    ...
    override suspend fun execute(params: Unit): ApiResult<Int> {
        return ApiResult.Success(data = passwordPolicy.maximumNumericSequenceLength)
    }
}
