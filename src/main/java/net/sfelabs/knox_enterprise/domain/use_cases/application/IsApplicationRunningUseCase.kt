 ...
 */
class IsApplicationRunningUseCase : WithAndroidApplicationContext, SuspendingUseCase<String, Boolean>() {
    ...
    override suspend fun execute(params: String): ApiResult<Boolean> {
        return ApiResult.Success(data = applicationPolicy.isApplicationRunning(params))
    }
}
